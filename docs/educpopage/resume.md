...
## [Le portail usager·ère](portail.md)

L'espace en ligne de chaque souscripteur·rice : ses contrats, son historique de
consommation, les relevés de son compteur et ses factures — avec de quoi
refaire le calcul soi-même. La page détaille ce qui s'y voit et la règle
d'étanchéité : chacun·e ne voit que ses contrats, et uniquement des documents
émis — jamais un brouillon en préparation côté équipe.

## [Les mails](mails.md)

À chaque moment important, un mail part tout seul : accusé de prise en compte,
pack de bienvenue, facture, remboursement. L'équipe garde la main sur les mots
qui changent — la lettre du mois, les textes d'accompagnement — pendant que le
code garde les chiffres : montants et instructions de paiement ne peuvent plus
être cassés par une faute de frappe.

## [Le consentement (données de consommation)](consentement.md)

Pour facturer, le relevé du compteur suffit : aucune autorisation à demander.
Pour collecter plus fin — la consommation jour par jour, la courbe détaillée —
il faut la permission explicite de la personne. La page explique comment cette
permission se donne, se retire, et comment chaque geste laisse une trace datée
dans un journal où rien ne s'efface : c'est lui, la preuve.

---

!!! info "Qui voit quoi"
    Tout le monde n'a pas les mêmes menus à l'écran, et c'est voulu.

    - Le·la **facturiste** voit tout le quotidien : les Souscriptions, les
    ...
    - Le menu **Paramètres** (le réglage du journal d'encaissement de la
      monnaie locale) demande, lui, les droits de configuration comptable.
    - L'**usager·ère**, enfin, ne voit que son espace en ligne : ses contrats
      et ses factures émises, rien du travail en cours ([portail.md](portail.md)).

    Moralité : si un menu manque à l'écran, ce n'est pas une panne — c'est une
    question de rôle.
