...
class TestCampagneLettreMois(SouscriptionsTestCase):
    ...
    def test_campagne_porte_un_champ_html_lettre_mois(self):
        ...
        campagne = self._campagne(date(2026, 5, 1), lettre_mois='<p>Bonjour à tous·tes !</p>')
    ...
    def test_lettre_de_m_moins_1_prefile_le_mois_m(self):
        ...
        campagne de M."""
        self._campagne(date(2026, 5, 1), lettre_mois='<p>Tarif solidaire : 30% des foyers.</p>')
    ...
    def test_editer_la_lettre_du_mois_suivant_ne_modifie_pas_le_mois_precedent(self):
        ...
        mai = self._campagne(date(2026, 5, 1), lettre_mois='<p>Version mai.</p>')
        juin = self._campagne(date(2026, 6, 1))
