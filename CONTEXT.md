...
Les deux étapes lourdes à l'échelle du parc (**créer** puis **émettre** les factures, mesurées à
81 s et 161 s sur 810 factures — cette dernière tuée par `limit_time_real`) s'exécutent en
**tâche de fond** : le bouton **demande**, il ne fait plus (ADR 0035, amende ADR 0025) — un cron
`ir.cron` natif vidange la liste de travail par paquets (API de progression, `_commit_progress`,
