...
class TestFacturation(TransactionCase):
    ...
    def test_abonnement_prorata_jours_exact(self):
        ...
        self.assertAlmostEqual(abo_31.price_unit * abo_31.quantity, prix_journalier * 31, places=4)
        self.assertAlmostEqual(abo_28.price_unit * abo_28.quantity, prix_journalier * 28, places=4)
